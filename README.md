...
For this project, our task was s to create a portfolio, using your new React skills.
...
- Used Xpert Learning Assistant about display each project components
- Tutoring session with Wesley Clement to debugg my code

## Screenshot

![Homepage](./public/ReactPortfolio.png)
